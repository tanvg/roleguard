...
def roleguard_filter_text(
    ...
    rewrite_prompt = (
        ...
        "- Do not use category names as values.\n"
        "- If a permitted value is not explicitly present in the original "
        "text, omit that field entirely. Do not write [unknown], "
        "[insert time], [insert X] or any placeholder. Only include "
        "fields with actual values from the original text.\n"
